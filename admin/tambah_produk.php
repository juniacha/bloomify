                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <input type="text" name="nama_produk" class="form-control"
                                placeholder="Masukkan nama bouquet" required>
                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <input type="file" name="gambar" class="form-control" accept="image/*" id="gambar" required>

                            <div class="preview-image mt-3">

                                <img id="preview" src="../assets/img/no-image.png">
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="harga_small" class="form-control" placeholder="Rp" required>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="harga_medium" class="form-control" placeholder="Rp" required>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="harga_large" class="form-control" placeholder="Rp" required>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="stok_small" class="form-control" required>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="stok_medium" class="form-control" required>
                        ...
                        <div class="col-lg-4 mb-4">
                            ...
                            <input type="number" name="stok_large" class="form-control" required>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="d-flex gap-3">
                                ...
                                <button type="submit" name="simpan" class="btn btn-bloom">
