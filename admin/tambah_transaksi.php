                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea name="alamat" id="alamat" class="form-control" rows="2"
                                placeholder="Isi alamat jika memilih Delivery" disabled></textarea>
                    ...
                    <div class="col-lg-5">
                        ...
                        <div class="form-admin-card mb-4">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <input class="form-check-input" type="checkbox" id="boneka" name="boneka">
                            ...
                            <div class="form-check mb-3">
                                ...
                                <input class="form-check-input" type="checkbox" id="balon" name="balon">
                            ...
                            <div class="form-check">
                                ...
                                <input class="form-check-input" type="checkbox" id="kartu_ucapan" name="kartu_ucapan">
    ...
    ========================= -->
                ...
                <div class="form-admin-card">
                    ...
                    <div class="d-flex justify-content-end gap-3 flex-wrap">
                        ...
                        <a href="transaksi.php" class="btn btn-light">
                        ...
                        <button type="reset" class="btn btn-outline-bloom">
                        ...
                        <button type="submit" name="pesan" class="btn btn-bloom">
