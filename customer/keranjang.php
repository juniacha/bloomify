                ...
                <div class="cart-card mb-5">
                    ...
                    <div class="row g-5 align-items-start">
                        ...
                        <div class="col-lg-5">
                            ...
                            <img src="../assets/img/<?= $data['gambar']; ?>" class="cart-image"
                        ...
                        <div class="col-lg-7">
                            ...
                            <form action="update_keranjang.php" method="POST">
                                ...
                                <div class="d-flex justify-content-between align-items-start mb-4">
                                    ...
                                    <a href="hapus_keranjang.php?id=<?= $data['id_keranjang']; ?>" class="delete-link"
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="qty-box">
                                        ...
                                        <a href="kurang_jumlah.php?id=<?= $data['id_keranjang']; ?>">
                                        ...
                                        <a href="tambah_jumlah.php?id=<?= $data['id_keranjang']; ?>">
                                ...
                                <div class="cart-footer">
                                    ...
                                    <div class="cart-button-group">
                                        ...
                                        <a href="checkout.php?id_produk=<?= $data['id_produk']; ?>&ukuran=<?= urlencode($data['ukuran']); ?>"
                                            class="btn btn-bloom">
