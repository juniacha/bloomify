...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarBloomify">
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item">
                        ...
                        <a class="nav-link active" href="pesanan_saya.php">
    ...
    <section class="py-5" style="background:var(--section);">
        ...
        <div class="container">
            <a href="index.php" class="back-link d-inline-flex mb-4">
                        ...
                        <div class="order-card">
                            ...
                            <div class="row align-items-center g-4">
                                ...
                                <div class="col-lg-3">
                                    ...
                                    <img src="../assets/img/<?= $data['gambar']; ?>" class="order-image"
                                ...
                                <div class="col-lg-3 text-lg-end">
                                    ...
                                    <?php if ($data['status'] == "Pesanan Masuk") { ?>
                                        ...
                                        <a href="batalkan_pesanan.php?id=<?= $data['id_transaksi']; ?>"
                                            onclick="return confirm('Batalkan pesanan ini?')" class="btn btn-outline-danger w-100">
